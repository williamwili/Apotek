...
<html lang="en">
  ...
  <body>
    ...
    <h1 align=center style="margin-top:30px;">Data Sediaan</h1>
		<br/>
		<?php 
			//Connection
				...
				<table border="2" class="table table-bordered w-75 align-middle" style="margin-left: auto; margin-right:auto; margin-bottom:50px; margin-top:30px; text-align:center;">
					...
					?>
								<tr>
									...
									<td><?= $data['nama']; ?></td>
									<td align="center"> 
										<a href="sediaan.php?aksi=edit&kd=<?= $data['kode']; ?>"><img src="icon/edit.ico" width=10% alt="edit" border="0" /></a> |
										<a href="sediaan.php?aksi=hapus&kd=<?= $data['kode']; ?>" onclick="return confirm('Yakin Hapus?')"><img src="icon/delete.ico" width=10% alt="delete" border="0" /></a>
									</td>
								</tr>
					<?php 
							} 
						...
						<table border ="0" cellspacing="5" class="container">
							...
							<tr>
								<td> 
									...
									<input type="button" 
										   value="Cancel" 
										   onclick="window.location.href='sediaan.php'"
